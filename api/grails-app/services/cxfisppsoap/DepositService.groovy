...
class DepositService {
  ...
  def processNewRecordUpload(lcidentifier,mdb,recon_record,json,owner,user,file) {
    ...
    recon_rec.pubStatus = 0; // 0=Pending, 1=Published, 2=Withdrawn, 3=Expired
    recon_rec.authStatus = 0; // 0=Pending approval, 1=Approved, 2=Withdrawn
  ...
  def uploadXML(file,authoritative,owner,user, contentType) {
    ...
    try {
      ...
      def canonical_record = [
        ...
        owner:owner,
        pubStatus : 0, // 0=Pending, 1=Published, 2=Withdrawn, 3=Expired
        authStatus : 0, // 0=Pending approval, 1=Approved, 2=Withdrawn
